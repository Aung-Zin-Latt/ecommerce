                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent='storeCoupon()'>
                            <div class="form-group">
                                <label for="c_code" class="col-md-4 control-label">Coupon Code</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label for="c_type" class="col-md-4 control-label">Coupon Type</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label for="c_value" class="col-md-4 control-label">Coupon Value</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label for="c_value" class="col-md-4 control-label">Cart Value</label>
                                <div class="col-md-4">
