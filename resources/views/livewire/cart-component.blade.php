    ...
    <main id="main" class="main-site">
        ...
        <div class="container">
            ...
            <div class=" main-content-area">
                ...
                {{-- Condition "if we don't have cart or cart is empty" --}}
                @if(Cart::instance('cart')->count() > 0)
                    <div class="wrap-iten-in-cart">
                                ...
                                @foreach (Cart::instance('cart')->content() as $item)
                                    <li class="pr-cart-item">
                                        ...
                                        <div class="quantity">
                                            ...
                                            <strong><p class="text-center"><a href="#" wire:click.prevent="switchToSaveForLater('{{ $item->rowId }}')">Save for Later</a></p></strong>
                        ...
                        @else
                            <p class="alert alert-danger">No Cart Found!</p>
                        @endif
                    </div>
                            ...
                            @foreach (Cart::instance('saveForLater')->content() as $item)
                                <li class="pr-cart-item">
                                    ...
                                    <div class="quantity">
                                        ...
                                        {{-- Add SaveForLater Option on Cart Page --}}
                                        <strong><p class="text-center"><a href="#" wire:click.prevent="moveToCart('{{ $item->rowId }}')">Move to Cart</a></p></strong>
